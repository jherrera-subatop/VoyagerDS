...
/* ── Vault gradient def (shared across category icons) ──────── */
const VAULT_GRAD_ID = "vmc-cat-vault";
function VaultGradDef(): JSX.Element {
  return (
    <defs>
      <linearGradient id={VAULT_GRAD_ID} x1="0" y1="0" x2="0" y2="1">
...
function MachineryIcon(): JSX.Element {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <VaultGradDef />
      <path d="M20 7.3C19.9 7.1 19.6 7 19.4 7H16.3C16 7 15.7 7.2 15.6 7.5L13.5 12.6H11.7L10.9 5.3C10.8 4.9 10.5 4.6 10.1 4.6H1.8C1.4 4.6 1 5 1 5.4 1 5.9 1.4 6.2 1.8 6.2H2.1V12.7C2 12.6 1.9 12.6 1.8 12.6 1.4 12.6 1 13 1 13.4V15.1C1 15.5 1.2 15.7 1.5 15.8 1.9 15.4 2.6 15.1 3.3 15.1H11.9L11.8 14.2H14.1C14.4 14.2 14.7 14 14.8 13.7L16.9 8.6H19L19.5 9.3H21.4L20 7.3ZM4.7 11H3.7V6.2H4.7V11ZM6.2 11V6.2H9.4L9.9 11H6.2V11Z" fill={VG} />
      <path d="M19.6 10.1V10.1 12.1C21.1 12.8 22.3 13.9 23 15.3V10.1H19.6Z" fill={VG} />
      <path d="M16.7 15.9H3.3C2.2 15.9 1.4 16.8 1.4 17.8 1.4 18.8 2.2 19.7 3.3 19.7H16.7C17.8 19.7 18.6 18.8 18.6 17.8 18.6 16.8 17.8 15.9 16.7 15.9ZM3.5 18.6C3 18.6 2.7 18.2 2.7 17.8 2.7 17.4 3 17 3.5 17 3.9 17 4.2 17.4 4.2 17.8 4.2 18.2 3.9 18.6 3.5 18.6ZM16.6 18.6C16.2 18.6 15.9 18.2 15.9 17.8 15.9 17.4 16.2 17 16.6 17 17.1 17 17.4 17.4 17.4 17.8 17.4 18.2 17.1 18.6 16.6 18.6Z" fill={VG} />
    </svg>
  );
}
...
function BoxIcon({ size = 24 }: { size?: number }): JSX.Element {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <VaultGradDef />
      <path d="M21 8.5V5.8C21 5.5 20.8 5.3 20.5 5.3H3.6C3.3 5.3 3.1 5.5 3.1 5.8V8.5H21Z" fill={VG} />
      <path d="M11 12.7H13.1C13.4 12.7 13.6 12.5 13.6 12.2 13.6 11.9 13.4 11.6 13.1 11.6H11C10.7 11.6 10.4 11.9 10.4 12.2 10.4 12.5 10.7 12.7 11 12.7Z" fill={VG} />
      <path d="M4.1 9.5V18.5C4.1 18.8 4.3 19 4.6 19H19.4C19.7 19 19.9 18.8 19.9 18.5V9.5H4.1ZM11 10.6H13.1C14 10.6 14.7 11.3 14.7 12.2 14.7 13 14 13.8 13.1 13.8H11C10.1 13.8 9.4 13 9.4 12.2 9.4 11.3 10.1 10.6 11 10.6Z" fill={VG} />
    </svg>
  );
}

/* ── Artículos Diversos: star icon with vault gradient ──────── */
function ArticulosIcon(): JSX.Element {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <VaultGradDef />
      <path d="M17.5 2.5 L19.5 8H22L17.5 11.2 19.2 17 14.5 13.5 9.8 17 11.5 11.2 7 8H9.5 Z" fill={VG} />
      <path d="M17 3L19 8.5H22L17.5 11.5 19.5 17.5 14.5 14 9.5 17.5 11.5 11.5 7 8.5H10Z" fill={VG} />
    </svg>
  );
}

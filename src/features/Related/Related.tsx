...
function SubasCoinIcon(): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className="flex-shrink-0 w-4 h-4">
...
function HeartIcon(): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className="w-4 h-4 fill-current" style={{ color: "color-mix(in oklch, var(--color-vault) 40%, oklch(1 0 0))" }}>
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-28">
        {/* Price badge */}
        <div
          className="absolute inline-flex items-center h-6 px-2 pointer-events-none z-10"
          style={{
            backgroundColor: "color-mix(in oklch, var(--color-live) 12%, oklch(1 0 0))",
            borderRadius: "0 0 var(--radius-sm, 4px) 0",
          }}
        >
          <SubasCoinIcon />
          <span
            className="pl-1 text-xs font-bold leading-tight"
            style={{ fontFamily: PJS, color: "var(--color-vault, #22005C)" }}
          >
            {price}
          </span>
        </div>
  ...
  return (
    ...
    >
      <h3
        ...
        style={{ fontFamily: PJS, color: "var(--color-vault-mid, #3B1782)" }}
      >
        Ofertas <span className="block">Relacionadas</span>
      </h3>

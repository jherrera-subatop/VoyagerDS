  ...
  return (
    <main style={{
      ...
      <div style={{
        ...
        <SectionLabel
          title="Sidebar"
          subtitle="226px · vault gradient · pvbtn-icon pattern · active accent naranja · promo card dual-layer border"
        />
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column" as const, gap: 10 }}>
            <p style={{ fontFamily: F, fontSize: 9, fontWeight: 700, textTransform: "uppercase" as const, letterSpacing: "0.10em", color: "oklch(0.55 0.03 220)", margin: 0 }}>Default · Hoy activo</p>
            <SidebarDemo activeId="hoy" />
          </div>
          {/* Categorías active */}
          <div style={{ display: "flex", flexDirection: "column" as const, gap: 10 }}>
            <p style={{ fontFamily: F, fontSize: 9, fontWeight: 700, textTransform: "uppercase" as const, letterSpacing: "0.10em", color: "oklch(0.55 0.03 220)", margin: 0 }}>Categorías activo</p>
            <SidebarDemo activeId="categorias" />
          </div>
          {/* Soporte active */}
          <div style={{ display: "flex", flexDirection: "column" as const, gap: 10 }}>
            <p style={{ fontFamily: F, fontSize: 9, fontWeight: 700, textTransform: "uppercase" as const, letterSpacing: "0.10em", color: "oklch(0.55 0.03 220)", margin: 0 }}>Centro de ayuda activo</p>
            <SidebarDemo activeId="ayuda" />
          </div>
        </div>

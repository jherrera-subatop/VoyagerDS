...
export const TAXONOMY_COMPONENTS: TaxonomyComponent[] = [
  ...
  },
  {
    ...
    origin: "VMC",
    decision: "solo-vmc",
    description: "Panel lateral de navegación principal. Brand area (logo + powered by) + 5 nav items con iconos circulares. Fondo vault oscuro #22005C. Aparece en Detalle y en todos los marcos autenticados.",
    instances: 1,
    frames: ["detalle"],
    measurements: {
      height: "100vh (sticky, scroll independiente)",
      ...
      extra: {
        ...
        "icon-size": "22px circular, 1.5px white border stroke",
        "background": "var(--vmc-color-background-inverse) = #22005C",
      },
    },
    subascarsMatch: "Sin match en SubasCars — componente exclusivo VMC",
  },
  {
    id: "display-price",
    name: "PriceDisplay",
